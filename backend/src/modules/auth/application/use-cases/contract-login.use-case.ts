...
import { ContractLoginDto } from '../dto/contract-login.dto.js';
import { v4 as uuidv4 } from 'uuid';

@Injectable()
export class ContractLoginUseCase {
  private readonly logger = new Logger(ContractLoginUseCase.name);
  ...
  async execute(dto: ContractLoginDto) {

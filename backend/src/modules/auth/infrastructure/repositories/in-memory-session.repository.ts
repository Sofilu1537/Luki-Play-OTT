...
export class InMemorySessionRepository
  implements SessionRepository, OnModuleInit
{
  ...
  onModuleInit(): void {
    ...
    const seeded: Session[] = [
      new Session({
        id: 'ses-001',
        userId: 'usr-001',
        deviceId: 'android-tv-sala',
        audience: Audience.APP,
        refreshTokenHash: 'seed-001',
      ...
      new Session({
        id: 'ses-002',
        userId: 'usr-001',
        deviceId: 'iphone-juan',
        audience: Audience.APP,
        refreshTokenHash: 'seed-002',
      ...
      new Session({
        ...
        deviceId: 'cms-admin-web',
        audience: Audience.CMS,
        refreshTokenHash: 'seed-004',
        createdAt: new Date(now - 90 * 60 * 1000),
        expiresAt: new Date(now + 7 * 24 * 60 * 60 * 1000),
      }),
      new Session({
        id: 'ses-005',
        userId: 'usr-soporte-001',
        deviceId: 'cms-soporte-web',
        audience: Audience.CMS,
        refreshTokenHash: 'seed-005',
